...
def setWith(s, symbols, i):
    if type(s) == Function('With') or type(s) == Function('Module'):
        ...
        if type(s.args[1]) == Function('CompoundExpression'): # Expand CompoundExpression
            ...
            C = s.args[1]
            constraints += sstr(C.args[1], sympy_integers=True)
